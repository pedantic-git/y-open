<template>
  <main>
    ...
    <section id="rules">
      <h3>Rules</h3>
      <p>We're an informal group and we don't like to have many rules, but we have to have a few in order to make sure that this is a safe space for people to talk about their relationships.</p>
      <ol>
