<template>
  <main>
    ...
    <section>
      ...
      <p>Our main <b>support &amp; community</b> meetup is online on Zoom on the evening of the first Thursday of every month. We also regularly meet up in person for members of our community to socialise.</p>
    </section>
    <section>
      <h2>Upcoming meetups</h2>
      <p>Here are the next few O.P.E.N events:</p>
      <Events/>
    ...
    <section>
      ...
      <p>Since the pandemic, we have been meeting online using Zoom: here's some information about how to <nuxt-link to="/find-us">find us on Zoom</nuxt-link>.</p>
    </section>
    <section>
      <h2>Been before?</h2>
      <p>Check out our <nuxt-link to="/members">members' section</nuxt-link> which contains details about our private <b>Discord</b>, the <b>library</b> and if you want to <b>help contribute</b> (time or money).</p>
    </section>
    <section>
      <h2>Get in touch</h2>
